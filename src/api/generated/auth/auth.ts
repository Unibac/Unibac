...
const authControllerRegister = (
 ...
 options?: SecondParameter<typeof customInstance<UsuarioResponseDto>>,) => {
  ...
  /**
 * Crea usuario EXTERNO con rol según categoría. Valida padrón (estudiante/egresado) o datos de empresa. Requiere PUBLIC_REGISTRATION_ENABLED=true.
 * @summary Registro público (usuarios externos por categoría)
 */
