 ...
 */
import type { EgresadosControllerFindAllEstadoLaboral } from "./egresadosControllerFindAllEstadoLaboral";

export type EgresadosControllerFindAllParams = {
  /**
   * Búsqueda parcial por nombre completo (sin distinguir mayúsculas)
   */
  nombre?: string;
  /**
   * Año de egreso exacto
   */
  anioEgreso?: number;
  /**
   * Búsqueda parcial por programa o carrera
   */
