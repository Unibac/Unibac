 ...
 */
import type { PostulacionConvocatoriaResponseDtoEstadoPostulacion } from './postulacionConvocatoriaResponseDtoEstadoPostulacion';
import type { PostulacionUsuarioResumenDto } from './postulacionUsuarioResumenDto';
import type { PublicacionEmprendimientoResponseDto } from './publicacionEmprendimientoResponseDto';

export interface PostulacionConvocatoriaResponseDto {
  id: number;
  usuarioId: number;
  publicacionId: number;
  fechaPostulacion: string;
  estadoPostulacion: PostulacionConvocatoriaResponseDtoEstadoPostulacion;
