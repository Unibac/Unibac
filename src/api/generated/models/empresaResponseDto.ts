 ...
 */
import type { EmpresaResponseDtoCorreoContacto } from './empresaResponseDtoCorreoContacto';
import type { EmpresaResponseDtoNombreContacto } from './empresaResponseDtoNombreContacto';
import type { EmpresaResponseDtoTelefono } from './empresaResponseDtoTelefono';
...
export interface EmpresaResponseDto {
  ...
  nit: string;
  razonSocial: string;
  nombreContacto?: EmpresaResponseDtoNombreContacto;
  correoContacto?: EmpresaResponseDtoCorreoContacto;
  telefono?: EmpresaResponseDtoTelefono;
  createdAt: string;
  updatedAt: string;
}
