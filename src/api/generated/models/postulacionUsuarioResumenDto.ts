 ...
 */
import type { PostulacionUsuarioResumenDtoCorreo } from "./postulacionUsuarioResumenDtoCorreo";

export interface PostulacionUsuarioResumenDto {
  id: number;
  usuario: string;
  correo?: PostulacionUsuarioResumenDtoCorreo;
}
