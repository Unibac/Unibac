...
export type UpdateTalentoPerfilDtoArea = typeof UpdateTalentoPerfilDtoArea[keyof typeof UpdateTalentoPerfilDtoArea];


export const UpdateTalentoPerfilDtoArea = {
  MUSICA: 'MUSICA',
