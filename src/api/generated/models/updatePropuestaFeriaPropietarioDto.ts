 ...
 */
import type { UpdatePropuestaFeriaPropietarioDtoAreaCreativa } from './updatePropuestaFeriaPropietarioDtoAreaCreativa';

export interface UpdatePropuestaFeriaPropietarioDto {
  nombreEmprendimiento?: string;
  /** @maxLength 500 */
  descripcionCorta?: string;
  imagenUrl?: string;
  areaCreativa?: UpdatePropuestaFeriaPropietarioDtoAreaCreativa;
