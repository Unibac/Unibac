 ...
 */
import type { UpdateDirectorioEmprendimientoDtoAreaCreativa } from './updateDirectorioEmprendimientoDtoAreaCreativa';

export interface UpdateDirectorioEmprendimientoDto {
  ...
  redes?: string;
  sitioWeb?: string;
  areaCreativa?: UpdateDirectorioEmprendimientoDtoAreaCreativa;
