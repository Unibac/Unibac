...
export type UsuarioWithPermisosResponseDtoTipo = typeof UsuarioWithPermisosResponseDtoTipo[keyof typeof UsuarioWithPermisosResponseDtoTipo];


export const UsuarioWithPermisosResponseDtoTipo = {
  INTERNO: 'INTERNO',
  EXTERNO: 'EXTERNO',
} as const;
